...
<div id="container" class="clear">
    ...
    <div class="adress_choice">
        ...
        <div id="addresId1">
            ...
            <i class="address_name">王翠花</i>
            <i class="user_address">北京市 海淀区 大钟寺123号 13566779988</i>
        </div>
        ...
        <div id="addresId1">
            ...
            <i class="address_name">刘铁蛋</i>
            <i class="user_address">北京市 海淀区 大钟寺123号 13566778899</i>
        </div>
