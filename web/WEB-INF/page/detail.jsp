...
<title>达内商城学子详情页</title>
    ...
    <link href="../SprinMvc_Login_war_exploded/css/animate.css" rel="stylesheet" />
    <link href="../SprinMvc_Login_war_exploded/css/footer.css" rel="stylesheet" />
    <link href="../SprinMvc_Login_war_exploded/css/pro.detail.css" rel="stylesheet" />
</head>
<body>
<!-- 页面顶部-->
<header id="top">
...
<div id="shop_detail">
    ...
    <div id="preview" class="lf">
        <div id="mediumDiv">
            <img id="mImg" src="../SprinMvc_Login_war_exploded/img/goods/<%=book.getIsbn() %>/detail1big.jpg"/>
        </div>
        <div id="icon_all">
            <ul id="icon_list">
                <li class="i1"><img src="../SprinMvc_Login_war_exploded/img/goods/<%=book.getIsbn() %>/detail1.jpg" /></li>
                <li class="i1"><img src="../SprinMvc_Login_war_exploded/img/goods/<%=book.getIsbn() %>/detail2.jpg" onerror="this.style.display='none'" /></li>
                <li class="i1"><img src="../SprinMvc_Login_war_exploded/img/goods/<%=book.getIsbn() %>/detail3.jpg" onerror="this.style.display='none'" /></li>
                <li class="i1"><img src="../SprinMvc_Login_war_exploded/img/goods/<%=book.getIsbn() %>/detail4.jpg" onerror="this.style.display='none'" /></li>
                <li class="li"><img src="../SprinMvc_Login_war_exploded/img/goods/<%=book.getIsbn() %>/detail5.jpg" onerror="this.style.display='none'" /></li>
            </ul>
        </div>
    </div>
    <!-- 右侧-->    
    <div class="right_detail lf">
        ...
        <p class="parameter">
            <b>客服：</b>
            <span class="connect">联系客服</span><img class="gif" src="../SprinMvc_Login_war_exploded/img/product_detail/kefuf.gif">
        </p>
        <!-- 出版社 -->
        ...
        <div class="shops">
            ...
            <a href="#" class="shop lf" id="add_cart"><img src="../SprinMvc_Login_war_exploded/img/product_detail/product_detail_img7.png" alt=""/>加入购物车</a>
            <a  class="collection lf" id="collect"><span>收藏</span></a>
            <b><img src='../SprinMvc_Login_war_exploded/img/product_detail/product_detail_img62.png' alt=""/></b>
        </div>
    </div>
   </div>
<!--为你推荐-->
         	  ...
         	  <div id="demo1" style="float:left"><!-- 第一个宽度显示 -->
           	     <div class="detail_1 lf">
           	        <div class="detail_img1">
           	            <a href="detail.html?isbn=9787302435167"><img src="../SprinMvc_Login_war_exploded/img/recommend/recommend_img1.jpg" border="0"></a>
             	    </div>
             	      <p>大数据架构师指南</p>
             	 </div>
             	<div class="detail_1 lf">
              	     <div class="detail_img1">
                 	      <a href="detail.html"><img src="../SprinMvc_Login_war_exploded/img/recommend/recommend_img2.jpg" border="0"></a>
                 	  </div>
                 	  <p>深入浅出Node.js</p>
                </div>
                <div class="detail_1 lf">
                 	  <div class="detail_img1">
                 	      <a href="detail.html"><img src="../SprinMvc_Login_war_exploded/img/recommend/recommend_img3.jpg" border="0"></a>
                  	 </div>
                  	 <p>Java编程思想</p>
               </div>
               <div class="detail_1 lf">
               	    <div class="detail_img1">
                 	      <a href="detail.html"><img src="../SprinMvc_Login_war_exploded/img/recommend/recommend_img4.jpg" border="0"></a>
                  	 </div>
                  	 <p>Linux运维最佳实践</p>
               </div>
           	</div>
...
<div id="iteminfo">
    <div id="tab">
        ...
        <div class="cart rt">
            <img src="../SprinMvc_Login_war_exploded/img/product_detail/product_detail_img9.png" alt=""/>
        </div>
    </div>
    <div class="left lf">
        <div class="all">
            ...
            <div id="parm">
                <div id="specification_parameter">
                    <p>规格参数<img src="../SprinMvc_Login_war_exploded/img/product_detail/product_detail_icon_1.png" alt="" class="ys5"/>
                    </p>
                </div>
                <ul>
                    <li><a href="#">图书编号：<%=book.getIsbn() %></a></li>
                    <li><a href="#">图书名称：Python数据科学指南</a></li>
                    <li><a href="#">作者：印度，Gopi，Subramania...</a></li>
                    <li><a href="#">价格：￥66.20</a></li>
                    <li><a href="#">出版社：人民邮电出版社</a></li>
                    <li><a href="#">版次：1</a></li>
                    <li><a href="#">出版日期：2016-11-01</a></li>
                    <li><a href="#">页数：380</a></li>
                    <li><a href="#">字数：122222</a></li>
            ...
            <div id="product_introduction">
                <p>
                    商品介绍
                    <img src="../SprinMvc_Login_war_exploded/img/product_detail/product_detail_icon_4.png" alt="" class="ys5"/>
                </p>
                <img src="../SprinMvc_Login_war_exploded/img/goods/<%=book.getIsbn() %>/intro.jpg" alt=""/>
            </div>
            <div id="sale_protection">
                <p>
                    售后保障
                    <img src="../SprinMvc_Login_war_exploded/img/product_detail/product_detail_icon_3.png" alt="" class="ys5"/>
                </p>

                <div class="sale_content">
                    <p class="paper" id="sale_protect">
                        <img src="../SprinMvc_Login_war_exploded/img/product_detail/product_detail_img16.png" alt=""/>
                        正品保障
                    </p>
    ...
    <div class="right rt">
        <div class="aside_nav">
            <p><i><img src="../SprinMvc_Login_war_exploded/img/product_detail/product_detail_icon_g_1.png" alt=""/></i><a href="#specification_parameter">规格参数</a></p>
            <p><i><img src="../SprinMvc_Login_war_exploded/img/product_detail/product_detail_icon_t_1.png" alt=""/></i><a href="#product_introduction">商品介绍</a></p>
            <p><i><img src="../SprinMvc_Login_war_exploded/img/product_detail/product_detail_icon_d_1.png" alt=""/></i><a href="#sale_protection">售后保障</a></p>
            <p><i><img src="../SprinMvc_Login_war_exploded/img/product_detail/product_detail_icon_up_1.png" alt=""/></i><a href="#">回到顶部</a></p>
        </div>
    </div>
</div>	
...
<script>
    $(function () {
		...
		$("#collect").click(function(){
			...
			$.ajax({
				type:"post",
				url:"${pageContext.request.contextPath}/addcollect",
				data:params,
