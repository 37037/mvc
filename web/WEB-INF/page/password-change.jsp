...
<head lang="en">
    ...
    <link href="../SprinMvc_Login_war_exploded/css/set.css" rel="stylesheet" />
</head>
<body>
<div id="header">
    <!-- 头部-->
...
<div id="container" class="clearfix">
    ...
    <div id="leftsidebar_box" class="lf">
        <div class="line"></div>
        <dl class="my_order">
            <dt onClick="changeImage()">帐号管理<img src="../SprinMvc_Login_war_exploded/img/myOrder/myOrder1.png"></dt>
...
<script type="text/javascript">
	...
	$("#cpwd").blur(function(){
	    $.post({
            url:"${pageContext.request.contextPath}/pass1",
            data:{"cpwd":$("#cpwd").val(),
                "npwd":$("#npwd").val()},
            success:function (msg) {
                if(msg == "yes"){
	...
	$('#bt-changep').click(function(){
        ...
        if($("#npwd").val()!="" && $("#accountCheck").text()=="yes" && $("#pwdValidate").text()=="相同"){
        	//异步提交请求
        	$.ajax({
        		async: true,
            	type: 'POST',
            	url: "${pageContext.request.contextPath}/pass2",
            	data: inputData,//提交整个表单的数据
            	success: function(msg){
            		// alert("*"+txt+"*");
                	if(msg=='yes'){  //修改成功
