...
<head lang="en">
    ...
    <link href="/SprinMvc_Login_war_exploded/css/my.order.css" rel="stylesheet"/>
    ...
    <div id="container" class="clearfix">
        ...
        <div id="leftsidebar_box" class="lf">
            ...
            <dl class="my_order">
                <dt onClick="changeImage()">我的订单
                    <img src="/SprinMvc_Login_war_exploded/img/myOrder/myOrder2.png">
                </dt>
        ...
        <div class="rightsidebar_box rt">
            ...
            <div id="orderItem">
              <p class="orderItem_title">
                 ...
                 <span>
                     <a href="#" class="servie">
                        联系客服<img src="/SprinMvc_Login_war_exploded/img/myOrder/kefuf.gif"/>
                      </a>
                 </span>
              </p>
            </div>
              <div id="orderItem_detail">
                  <ul>
                      <li class="product">
                          <b><a href="#"><img src="/SprinMvc_Login_war_exploded/img/goods/9787302383666/detail1.jpg" /></a></b>
                      ...
                      <li class="trading_status">
                          <img src="/SprinMvc_Login_war_exploded/img/myOrder/car.png" alt=""/>已发货
                          <br/>
		...
		<div class="rightsidebar_box rt" >
		      <div class="order_empty">
		          <img src="/SprinMvc_Login_war_exploded/img/myOrder/myOrder3.png" alt=""/>
		         <p>你可能还没有订单(⊙o⊙)</p>
...
<script src="/SprinMvc_Login_war_exploded/js/jquery.page.js"></script>
<script src="/SprinMvc_Login_war_exploded/js/order.js"></script>
...
$(".tcdPageCode").createPage({
    ...
    backFn:function(pageIndex){
        ...
        window.location.href='/SprinMvc_Login_war_exploded/servlet/show-order?pageIndex='+pageIndex+'&start='+start+'&length='+${requestScope.length };
    }
});
*/
</script>
