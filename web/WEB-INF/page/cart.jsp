<%@ page import="cn.ahpu.springmvc.pojo.cart" %>
...
<head lang="en">
    ...
    <link href="/SprinMvc_Login_war_exploded/css/cart.css" rel="stylesheet" />
</head>
<body>
<!-- 页面顶部-->
<header id="top">
...
<div class="modal" style="display:none">
    <div class="modal_dialog">
        ...
        <div class="modal_information">
            <img src="/SprinMvc_Login_war_exploded/img/model/model_img2.png" alt=""/>
...
<div class="modalNo" style="display:none">
    <div class="modal_dialog">
        <div class="modal_header">
            删除提示
            <img src="/SprinMvc_Login_war_exploded/img/model/model_img1.png" alt="" class="rt close"/>
        </div>
        <div class="modal_information">
            <img src="/SprinMvc_Login_war_exploded/img/model/model_img2.png" alt=""/>
            <span>请选择商品</span>
...
<div class="big">
            ...
            <div id="content_box">
                <div class="imfor_top">
                    <div class="check_top">
                        <div class="all">
                            <span class="normal">
                                <img src="/SprinMvc_Login_war_exploded/img/cart/product_normal.png" alt=""/>
                ...
                <div class="imfor">
                    ...
                    <div class="pudc">
                        <div class="pudc_information" id="<%=cart1.getRid()%>">
                            <img src="/SprinMvc_Login_war_exploded/img/goods/<%=cart1.getProduct()%>/detail1.jpg" class="lf"/>
                            <input type="hidden" name="" value="">
                        <span class="des lf">
                    ...
                    <div class="num"><span class="reduc">&nbsp;-&nbsp;</span><input type="text" value="<%=cart1.getCount()%>" ><span class="add">&nbsp;+&nbsp;</span></div>
                    <div class="totle">
                        <span>￥</span>
    ...
    <div class="none" style="display: none">
        ...
        <div class="none_content">
            <img src="/SprinMvc_Login_war_exploded/img/30.png" alt="" class="lf"/>
...
<script src="/SprinMvc_Login_war_exploded/js/cart.js"></script>
...
<script>
    ...
    $(function(){
      ...
      //删除当前行
    	$('.del_d').click(function() {
    			...
    			$('.yes').click(function(){
    				var url ='${pageContext.request.contextPath}/delete?rid='+id;
	...
	$(".add").each(function() {
		$(this).click(function() {
			...
			$multi = parseInt(vall).toFixed(2) * parseFloat($(this).parent().prev().children().eq(1).children().eq(1).text());
